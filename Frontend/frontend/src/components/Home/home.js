...
function Home (){
    ...
    <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)"}}><h1><marquee>Welcome to the world of E Banking!</marquee></h1><br/><strong style={{color:"whitesmoke" ,fontSize:"23px"}}> We are providing
